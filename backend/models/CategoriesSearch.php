...
class CategoriesSearch extends Categories
{
    ...
    {
        return [
            [['id', 'parent_id', 'display_order', 'status', 'updated_by', 'created_at', 'updated_at'], 'integer'],
            [['name', 'slug',  'meta_title', 'meta_keyword', 'meta_description', 'added_date', 'updated_date'], 'safe'],
        ];
    }
